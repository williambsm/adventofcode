...
function solution(input) {
    ...
    boxes.forEach(function(box) {
        ...
        for(x=0;x<box.length;x++) {
            typeof letters[box[x]] === 'undefined' ? letters[box[x]] = 1 : letters[box[x]]++;
        }
